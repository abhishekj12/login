                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="jquery-val-form" method="POST" action="{{ route('permissions.store') }}"
                                            ...
                                            <div class="mb-1">
                                                <label class="form-label" for="basic-default-name">dispayName</label>
                                                <input type="text" class="form-control" id="basic-default-name"
                                                    name="displayname" placeholder="Enter your name" />
                                            </div>
                                            <div class="mb-1">
                                                <label class="form-label" for="basic-default-name">discription</label>
                                                <input type="text" class="form-control" id="basic-default-name"
                                                    name="displaydicription" />
                                            </div>
                                            <br>
