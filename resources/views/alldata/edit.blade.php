                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="jquery-val-form" method="POST"
                                            action="{{ route('alldata.update', $crud->id) }}"
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control" id="basic-default-name"
                                                    value="{{ $crud->name }}" name="basic-default-name" />
                                            </div>

                                            <div class="mb-1">
                                                <label class="form-label" for="select-country">Country</label>
                                                <select class="form-select select2" id="country-dropdown"
                                                    name="select-country">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="form-check my-50">
                                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                                        name="hobbys[]" {{ in_array('play', $hobbys) ? 'checked' : '' }}
                                                        value="play" />
                                                    <label class="form-check-label" for="inlineCheckbox1">play</label>
                                                </div>
                                                <div class="form-check my-50">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="inlineCheckbox1"name="hobbys[]"
                                                        {{ in_array('sing', $hobbys) ? 'checked' : '' }} value="sing" />
                                                ...
                                                <div class="form-check my-50">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                                        name="hobbys[]"
                                                        {{ in_array('cricket', $hobbys) ? 'checked' : '' }}
                                                        value="cricket" />
