...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list">
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ asset('admin/app-assets/images/pages/eCommerce/1.png') }}" alt="donuts"
                                    width="62">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ asset('admin/app-assets/images/pages/eCommerce/7.png') }}" alt="donuts"
                                    width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ asset('admin/app-assets/images/pages/eCommerce/2.png') }}" alt="donuts"
                                    width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ asset('admin/app-assets/images/pages/eCommerce/3.png') }}" alt="donuts"
                                    width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ asset('admin/app-assets/images/pages/eCommerce/5.png') }}" alt="donuts"
                                    width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
    ...
    <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                ...
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('admin/app-assets/images/icons/xls.png') }}"
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('admin/app-assets/images/icons/jpg.png') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('admin/app-assets/images/icons/pdf.png') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('admin//app-assets/images/icons/doc.png') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar me-75"><img
                            src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-14.jpg') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            @can('user_show')
            <li class="nav-item
                @if (\Request::route()->getName() == 'data.index' || Request::segment(1) == 'data') active @endif
            ">
            <a class="d-flex align-items-center menu-link" href="{{ route('data.index') }}"> User</a>
        </li>
            @endcan

            <li class="nav-item
                @if (\Request::route()->getName() == 'alldata.index' || Request::segment(1) == 'alldata') active @endif"><a
                    class="d-flex align-items-center menu-link" href="{{ route('alldata.index') }}">Detail</a>
            </li>


            <li class="nav-item
                @if (\Request::route()->getName() == 'permissions.index' || Request::segment(1) == 'permissions') active @endif
                "><a
                    class="d-flex align-items-center  menu-link" href="{{ route('permissions.index') }}">
                    Permission</a>
            </li>

            <li class="nav-item
                @if (\Request::route()->getName() == 'roles.index' || Request::segment(1) == 'roles') active @endif">
                <a class="d-flex align-items-center menu-link" href="{{ route('roles.index') }}"> Role

                </a>
            </li>

            <li class="nav-item
            @if (\Request::route()->getName() == 'rolepermission.index' || Request::segment(1) == 'rolepermission') active @endif">
            <a class="d-flex align-items-center menu-link" href="{{ route('rolepermission.index') }}"> Role Permission

            </a>
        </li>
        <li class="nav-item              @if (\Request::route()->getName() == 'chat.index' || Request::segment(1) == 'chat') active @endif">

        <a class="d-flex align-items-center menu-link" href="{{ route('chat.index') }}"> Chat
