                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="jquery-val-form" method="POST"
                                            action="{{ route('rolepermission.update', $role->id) }}"
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="form-check my-50">
                                                    <label class="d-block form-label"
                                                        style="margin-left:-20px; ">Pemission:</label>
                                                    @foreach ($permission_data as $key => $value)
                                                        <td style="">{{ $value }}</td>
                                                        <input type="checkbox" name="permission[{{ $value }}]"
                                                            value="{{ $value }}"
                                                            {{ in_array($value, $permission) ? 'checked' : '' }}
                                                            value="sing" class='permission'>
                                                    @endforeach
                                                </div>
                                                <br>
