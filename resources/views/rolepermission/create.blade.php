    ...
    @section('maincontent')
        ...
        <body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
            ...
            <div class="app-content content ">
                <a href="{{ route('rolepermission.index') }}" style="margin-left:670px "
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="jquery-val-form" method="POST"
                                                action="{{ route('rolepermission.store') }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="mb-1">
                                                    <label class="form-label" for="basic-default-name"> Role Name</label>
                                                    <input type="text" class="form-control" id="basic-default-name"
                                                        name="rolename" placeholder="Enter your name" />
                                                </div>
                                                <div class="mb-1">
                                                    <label class="d-block form-label">Pemission:</label>
                                                    <div class="form-check my-50">
                                                        ...
                                                        {{-- @foreach ($permissions as $permission)
                                                            ...
                                                            <input type="checkbox" name="permission[{{ $permission->name }}]"
                                                                value="{{ $permission->name }}" class='permission'><br>
                                                        @endforeach --}}
                                                    </div>
                                                </div>
                                                <br>
